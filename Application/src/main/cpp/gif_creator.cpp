...
extern "C" {
JNIEXPORT jint JNICALL Java_com_example_android_camera2basic_Init(JNIEnv *ioEnv, jobject ioThis, jstring gifName,
                                                             jint w, jint h, jint numColors, jint quality, jint frameDelay);
JNIEXPORT void JNICALL Java_com_example_android_camera2basic_Close(JNIEnv *ioEnv, jobject ioThis);
JNIEXPORT jint JNICALL Java_com_example_android_camera2basic_AddFrame(JNIEnv *ioEnv, jobject ioThis, jintArray inArray);
};
